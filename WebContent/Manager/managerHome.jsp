...
<body style="background: linear-gradient(to right, #d7d2cc 0%, #304352 100%)">
    <%
        ...
        try {
            ...
            String query = "SELECT first_name FROM Employee WHERE username = ?"; PreparedStatement ps = con.prepareStatement(query);
        ...
        catch (Exception e) { System.out.println("Error fetching employee details: " + e.getMessage()); }
    %>
    ...
    <nav class="w-100pc flex flex-column md-flex-row md-px-10 py-5" style="background: linear-gradient(to right, #d7d2cc 0%, #304352 100%)">
        ...
        <div  id="nav-items"  class="hidden flex sm-w-100pc flex-column md-flex md-flex-row md-justify-end items-center">
	        ...
	        <div class="nav-links">
                <a href="salesAnalysis.jsp">Summary</a> <a href="supportSignIn.jsp">Manage Support</a> 
    ...
    <section id="home" class="min-h-100vh flex flex-column justify-center items-center">
        <div class="text-center mx-5 md-mx-l5">
            ...
            <p class="white fs-m1 mt-3">Manage support, update representative data, track reservations and sales, and analyze revenue by 
            							customer, transit line, or top metrics.</p>
        </div>
    </section>
